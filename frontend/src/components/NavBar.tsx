...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-40 flex justify-center">
      <div className="mt-6 bg-white/70 backdrop-blur-md border border-blue-100 shadow-xl flex w-[90%] max-w-[1400px] h-[80px] items-center rounded-full justify-between px-6 md:px-10 transition-all duration-300">
        {/* Logo Section */}
        <a
          href="/"
          className="flex items-center gap-3 text-[28px] font-bold text-gray-800"
        >
          <Image
            alt="Logo"
            src="/images/logo.png"
          ...
          />
          <span>
            <span style={{ color: "#0178d9" }}>Soft</span>Sight
          </span>
        </a>
